...
const projects = [
  {
    title: "URL Shortener",
    description:
      "A URL shortening application built using HTML, CSS, JavaScript, Python(Flask), and MySQL. It allows users to shorten long URLs and provides a user-friendly interface for managing shortened links.",
  ...
  },
  {
    title: "Maze Game",
    description:
      "A fun, interactive maze game built using only HTML, CSS, and JavaScript. This full JavaScript-based project allows users to navigate through a randomly generated maze and reach the exit.",
    image: mazeGameImg,
  ...
  },
  {
    ...
    description:
      "A simple and interactive To-Do List application built using React.js and TailwindCSS. It allows users to add, edit, and delete tasks, with persistent storage using browser local storage.",
    image: todoAppImg,
  ...
  },
  {
    ...
    description:
      "A simple and responsive calculator built using React.js and TailwindCSS. It supports basic arithmetic operations, percentage calculations, and features a modern dark-themed UI.",
  ...
  },
  {
    ...
    description:
      "A Trello-style task management application built with Next.js, Supabase, and Clerk. Features real-time collaboration, drag-and-drop functionality, authentication, billing integration, and advanced filtering capabilities.",
    ...
    // demoUrl: "#",
    githubUrl: "https://github.com/Samraj5413/Trello-Clone-App",
  },
];
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            ...
            development, machine learning, and creative problem-solving.
          </p>
        </motion.div>
